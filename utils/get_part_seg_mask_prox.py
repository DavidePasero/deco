...
# python utils/get_part_seg_mask_prox.py --data_npz datasets/Release_Datasets/prox/train-prox.npz --model_type 'smplx'
...
def main(args):
    ...
    # img_paths, seg_paths = img_paths[:1], seg_paths[:1]
    # print(img_paths, seg_paths)
